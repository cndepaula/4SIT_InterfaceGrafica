...
public class Atividade_CalcularMediaIG extends JPanel {
	
	/*
	 
	 by: Cauan de Paula e Gustavo Candido - 4SIT
	
	 */
	JLabel lbnome, lbnumero ,lbturma, lbnota1, lbnota2, lbnota3 ,lbcalcular, lbimg, lbimg2, lbimg3;// texto ou imagem não editável
	JTextField tfnome, tfnumero, tfturma, tfnota1, tfnota2, tfnota3 ; //campo de texto 
	JButton btcalcular; //botão
	...
	public void inicializarComponentes() {
		//tirando o layout
		setLayout(null);
		//instanciando os objetos gráficos
		...
		img1 = new ImageIcon("C:\\Users\\C.Vinicius\\Desktop\\logo.png");
		lbimg = new JLabel(img1);
		img2 = new ImageIcon("C:\\Users\\C.Vinicius\\Desktop\\happy.png");
		lbimg2 = new JLabel(img2);
		img3 = new ImageIcon("C:\\Users\\C.Vinicius\\Desktop\\sad.png");
		lbimg3 = new JLabel(img3);
		

		
		//definir posição e tamanho dos componentes
		
		lbnome.setBounds(90,10,40,40); //setBounds define posição dos componentes (x,y) e o tamanho (largura, altura)
		...
		btcalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (resu > 6) {
					...
					lbcalcular.setText("O aluno, " + tfnome.getText() + " da turma " + tfturma.getText() + " número " + tfnumero.getText() + ", com a média de: " + formatador.format(resu) + " está aprovado.");
				}
				if (resu > 4 && resu < 6) {
					lbcalcular.setText("O aluno, " + tfnome.getText() + " da turma " + tfturma.getText() + " número " + tfnumero.getText() + ", com a média de: " + formatador.format(resu) + " está de recuperação.");
					}
				if (resu < 4) {
					lbimg3.setVisible(true);
					lbcalcular.setText("O aluno, " + tfnome.getText() + " da turma " + tfturma.getText() + " número " + tfnumero.getText() + ", com a média de: " + formatador.format(resu) + " está reprovado.");
					}
				}		
	});
	...
	public static void main(String args[]){
 		JFrame frame = new JFrame("Média Escolar");
